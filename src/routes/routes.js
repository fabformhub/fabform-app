import { Dashboard, Login, Signup, FormViewer, FormResponses, FormBuilder, Test, Share,Integrate, Settings, ChangeEmail, ChangePassword,Order } from '../pages';
...
export default [
  ...
  { path: 'order', component: Order, hooks: { pre: requireAuth } },
