...
const uiMeta = {
  ...
  backgroundColor: '#FFF7CC', // buttery yellow
  backgroundImage: '',

  color: '#2B2D42',
  answerColor: '#555B6E',

  buttonColor: '#00C896', // cheerful green
  buttonTextColor: '#FFFFFF',

  starRatingColor: '#FFB800',
...
<div class="p-6 bg-gray-50 text-black min-h-screen">
  ...
  <div class="flex justify-between items-center mb-6">
    <div>
      ...
      <span
        class={`px-3 py-1 rounded-full text-sm font-semibold ${isUserPaid
